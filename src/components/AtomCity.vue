<template>
    ...
    <div>
      ...
      <div class="form-group">
        ...
        <label>{{account.countryAdd}}</label>
        ...
        <div class="input-group height-fix-6">
            ...
            <select class="form-control" v-model="selectCountry" v-on:change="getCount($event)">
                ...
                <option value="" selected>{{message.pleaseEnter}}</option>
      ...
      <div class="form-group">
          ...
          <div v-if="selectCountry=='中国'">
            ...
            <label>{{account.provinceAdd}}</label>
        ...
        <div v-if="selectCountry!='中国' && selectCountry!=''" >
            ...
            <div class="input-group height-fix-6">
              ...
              <input type="text" v-model="selectProv" class="form-control" :placeholder="message.pleaseEnter">
            ...
            <div class="input-group height-fix-6">
              ...
              <input type="text" v-model="selectCity" class="form-control" :placeholder="message.pleaseEnter">
