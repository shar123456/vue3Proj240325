...
import CommonQueryWinHeaderCRM from "@/components/CommonQueryWinHeaderCRM.vue";
...
export default defineComponent({
      props: { ListColumns:Object,ListDatas:Object,
       ...
       components: {
    PlusSquareFilled,CommonQueryWinHeaderCRM
  },
    setup (props,context) {
...
const selectRecord=(item:any)=>{
    selectedRows.value=[];
    console.log("addStepsFuncproduct",item);
